...
select ename,sal, sal+sal*10/100 as "salary with hike"
from emp;

-- WAQTD NAME AND SALARY WITH DEDUCTION OF 25%.
select ename,sal-sal*25/100 as "sal after deduction"
from emp;

-- WAQTD NAME AND SALARY WITH MONTHLY HIKE OF 50.
select ename, sal+50 as "salary with 50 hike"
from emp;
-- WAQTD NAME AND ANNUAL SALARY WITH DEDUCTION OF 10%.
select ename,sal, sal-sal*10/100 as "salary with 10% dedectuion"
from emp;
-- WAQTD TOTAL SALARY GIVEN TO EACH EMPLOYEE (SAL+COMM) .
select ename,sal, sal+comm as "salary with comm"
from emp;
...
select ename,job, sal-100 as "salary 100 penalty"
from emp;